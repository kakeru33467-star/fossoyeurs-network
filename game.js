...
exit:{x:18,y:18},
enemies:[
{path:[{x:2,y:1},{x:17,y:1},{x:17,y:10},{x:2,y:10}], speed:350}
]
},
...
exit:{x:1,y:1},
enemies:[
{path:[{x:1,y:9},{x:18,y:9}], speed:250},
{path:[{x:10,y:1},{x:10,y:18}], speed:220}
]
},
...
{path:[{x:10,y:1},{x:10,y:18}], speed:170},
{path:[{x:2,y:2},{x:17,y:17}], speed:150}
]
}
